...
lastmod: 2022-04-22T18:20:06+08:00
draft: false
...
* 关于旋转，先看一个实例：
  ![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_3.jpg)
* 红黑树旋转的具体规则如下(假设插入的节点为X)：
  ...
  3. 如果 X 的 parent 不是黑色，同时 X 也不是 root（3⃣️）:
     * 如果 X 的 uncle (叔叔) 是红色：
       ...
       ![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_5.jpg)
       *图中的g节点最后为黑色，因为是根节点*
     * 如果 X 的 uncle (叔叔) 是黑色，我们要分四种情况去处理：
       1. 左左 (P 是 G 的左孩子，并且 X 是 P 的左孩子)：
       ![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_6.jpg)
       **想象这是一根绳子，手提起 P 节点，然后变色即可**
       2. 左右 (P 是 G 的左孩子，并且 X 是 P 的右孩子)：
       ![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_7.jpg)
       **左旋: 使 X 的父节点 P 被 X 取代，同时父节点 P 成为 X 的左孩子，然后再应用左左情况**
       3. 右右 (和 3.2.1 镜像过来，恰好相反)：
       ![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_8.jpg)
       **与左左情况一样，想象成一根绳子**
       4. 右左 (和 3.2.2 镜像过来，恰好相反)：
       ![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_9.jpg)
...
![](https://blog-1311257248.cos.ap-nanjing.myqcloud.com/imgs/stl/img10_4.jpg)
